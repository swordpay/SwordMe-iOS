...
private func privacyAndSecurityControllerEntries(
    ...
    entries.append(.dataSettingsInfo(presentationData.theme, presentationData.strings.PrivacySettings_DataSettingsHelp.replacingOccurrences(of: "Telegram", with: "Sword")))
