            ...
            if let strongSelf = self {
                switch result {
                   ...
                   case let .replyThreadMessage(replyThreadMessage, messageId):
                    ...
                    case let .invoice(_, invoice):
                        if invoice != nil {
                            strongSelf.controllerInteraction.presentController(textAlertController(context: strongSelf.context, updatedPresentationData: strongSelf.controller?.updatedPresentationData, title: nil, text: "Unfortunalety, this feature is not available in your app version.", actions: [TextAlertAction(type: .defaultAction, title: strongSelf.presentationData.strings.Common_OK, action: {})]), nil)
