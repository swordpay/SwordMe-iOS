    ...
    public var selectedIndex: Int {
        get {
            ...
            if _selectedIndex != index {
                ...
                // MARK: - SwordChange
//                let shouldLockOrientation = index == 1 || index == 2
    ...
    public init(navigationBarPresentationData: NavigationBarPresentationData, theme: TabBarControllerTheme) {
        ...
        bindToCryptoAccountStatusUpdate()
    }
    ...
    private func bindToCryptoAccountStatusUpdate() {
        NotificationCenter.default.publisher(for: Notification.Name(rawValue: "cryptoAccuntStatusUpdateShouldUpdated"))
            .sink { [ weak self ] _ in
