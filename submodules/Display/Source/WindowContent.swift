...
public class Window1 {
    ...
    public init(hostView: WindowHostView, statusBarHost: StatusBarHost?) {
        ...
        self.badgeView.image = nil // UIImage(bundleImageName: "Components/AppBadge") // MARK: - SwordChange
        ...
        // MARK: - SwordChange / Commented the part below, maybe in the future we will find better solution
