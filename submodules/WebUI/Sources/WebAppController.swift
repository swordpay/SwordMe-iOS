    ...
    fileprivate class Node: ViewControllerTracingNode, WKNavigationDelegate, WKUIDelegate, UIScrollViewDelegate {
        ...
        private func handleScriptMessage(_ message: WKScriptMessage) {
            ...
            switch eventName {
                ...
                let alertController = textAlertController(context: self.context, updatedPresentationData: self.controller?.updatedPresentationData, title: nil, text: "Unfortunalety, this feature is not available in your app version.", actions: [TextAlertAction(type: .defaultAction, title: presentationData.strings.Common_OK, action: {})])
                self.controller?.present(alertController, in: .window(.root))
