...
private let swordAppColor = UIColor(rgb: 0x093489)
...
public let defaultDayAccentColor = UIColor(rgb: 0x093489)
...
public func customizeDefaultDayTheme(theme: PresentationTheme, editing: Bool, title: String?, accentColor: UIColor?, outgoingAccentColor: UIColor?, backgroundColors: [UInt32], bubbleColors: [UInt32], animateBubbleColors: Bool?, wallpaper forcedWallpaper: TelegramWallpaper? = nil, serviceBackgroundColor: UIColor?) -> PresentationTheme {
    ...
    // MARK: - SwordChange / added converting of UInt32 -> UInt64
    if !bubbleColors.isEmpty {
        outgoingBubbleFillColors = bubbleColors.map { UIColor.init(rgb: $0) }
        ...
        let lightnessColor = UIColor.average(of: bubbleColors.map { UIColor.init(rgb: $0) })
...
public func makeDefaultDayPresentationTheme(extendingThemeReference: PresentationThemeReference? = nil, serviceBackgroundColor: UIColor?, day: Bool, preview: Bool) -> PresentationTheme {
    ...
    let intro = PresentationThemeIntro(
        ...
        dotColor: UIColor(rgb: 0xF6F8FC),
        highlightedDotColor: UIColor(rgb: 0x6B6E75)
    )
    ...
    let rootNavigationBar = PresentationThemeRootNavigationBar(
        buttonColor: UIColor(rgb: 0x093489),
        disabledButtonColor: UIColor(rgb: 0xd0d0d0),
        primaryTextColor: UIColor(rgb: 0x000000),
        secondaryTextColor: UIColor(rgb: 0x787878),
        controlColor: UIColor(rgb: 0x7e8791),
        accentTextColor: UIColor(rgb: 0x093489),
        blurredBackgroundColor: .white,
    ...
    let rootTabBar = PresentationThemeRootTabBar(
        ...
        selectedTextColor: swordAppColor,
        badgeBackgroundColor: UIColor(rgb: 0xff3b30),
        badgeStrokeColor: UIColor(rgb: 0xff3b30),
        badgeTextColor: UIColor(rgb: 0xffffff)
    )
    ...
    let navigationSearchBar = PresentationThemeNavigationSearchBar(
        ...
        inputFillColor: UIColor(rgb: 0xF6F8FC),
    ...
    */
    let serviceMessage = PresentationThemeServiceMessage(
        components: PresentationThemeServiceMessageColor(withDefaultWallpaper:
                                                            PresentationThemeServiceMessageColorComponents(fill: UIColor(rgb: 0x939fab, alpha: 0.5), primaryText: UIColor(rgb: 0xffffff), linkHighlight: UIColor(rgb: 0x748391, alpha: 0.25), scam: UIColor(rgb: 0xffffff), dateFillStatic: UIColor(rgb: 0xD9D9D9), dateFillFloating: UIColor(rgb: 0xD9D9D9)),
                                                         withCustomWallpaper: PresentationThemeServiceMessageColorComponents(fill: serviceBackgroundColor, primaryText: UIColor(rgb: 0xffffff), linkHighlight: UIColor(rgb: 0x748391, alpha: 0.25), scam: UIColor(rgb: 0xffffff), dateFillStatic: UIColor(rgb: 0xD9D9D9), dateFillFloating: UIColor(rgb: 0xD9D9D9))),
        ...
        dateTextColor: PresentationThemeVariableColor(color: UIColor(rgb: 0x2F3032))
    )
    
    let serviceMessageDay = PresentationThemeServiceMessage(
        components: PresentationThemeServiceMessageColor(withDefaultWallpaper: PresentationThemeServiceMessageColorComponents(fill: UIColor(rgb: 0xffffff, alpha: 0.8), primaryText: UIColor(rgb: 0x8d8e93), linkHighlight: UIColor(rgb: 0x748391, alpha: 0.25), scam: UIColor(rgb: 0xff3b30), dateFillStatic: UIColor(rgb: 0xD9D9D9), dateFillFloating: UIColor(rgb: 0xD9D9D9)),
                                                         withCustomWallpaper: PresentationThemeServiceMessageColorComponents(fill: serviceBackgroundColor, primaryText: UIColor(rgb: 0xffffff), linkHighlight: UIColor(rgb: 0x748391, alpha: 0.25), scam: UIColor(rgb: 0xff3b30), dateFillStatic: UIColor(rgb: 0xD9D9D9), dateFillFloating: UIColor(rgb: 0xD9D9D9))),
        unreadBarFillColor: UIColor(rgb: 0xffffff),
        unreadBarStrokeColor: UIColor(rgb: 0xffffff),
        unreadBarTextColor: UIColor(rgb: 0x8d8e93),
        dateTextColor: PresentationThemeVariableColor(withWallpaper: UIColor(rgb: 0x2F3032), withoutWallpaper: UIColor(rgb: 0x2F3032))
    )
...
//    )
    ...
    let swordInputPanel = PresentationThemeChatInputPanel(
        panelBackgroundColor: UIColor(rgb: 0xffffff),
        panelBackgroundColorNoWallpaper: UIColor(rgb: 0xffffff),
        panelSeparatorColor: .white,
        panelControlAccentColor: defaultDayAccentColor,
        panelControlColor: UIColor(rgb: 0x858e99),
        panelControlDisabledColor: UIColor(rgb: 0x727b87, alpha: 0.5),
        panelControlDestructiveColor: UIColor(rgb: 0xff3b30),
        inputBackgroundColor: UIColor(rgb: 0xF6F8FC),
        inputStrokeColor: UIColor(rgb: 0x000000, alpha: 0.1),
        inputPlaceholderColor: UIColor(rgb: 0xbebec0),
        inputTextColor: UIColor(rgb: 0x000000),
        inputControlColor: UIColor(rgb: 0x868D98),
    ...
    let swordMessage = PresentationThemeChatMessage(
       incoming: PresentationThemePartedColors(
           bubble: PresentationThemeBubbleColor(
               withWallpaper: PresentationThemeBubbleColorComponents(
                   fill: [UIColor(rgb: 0xFAFAFA)],
                   highlightedFill: UIColor(rgb: 0xd9f4ff),
                   stroke: bubbleStrokeColor,
                   shadow: nil,
                   reactionInactiveBackground: defaultDayAccentColor.withMultipliedAlpha(0.1),
           ...
           primaryTextColor: UIColor(rgb: 0x2F3032),
           secondaryTextColor: UIColor(rgb: 0x000000).withAlphaComponent(0.25),
           linkTextColor: UIColor(rgb: 0x004bad),
           linkHighlightColor: defaultDayAccentColor.withAlphaComponent(0.3),
           scamColor: UIColor(rgb: 0xff3b30),
           textHighlightColor: UIColor(rgb: 0xffe438),
           ...
           actionButtonsFillColor: PresentationThemeVariableColor(withWallpaper: serviceBackgroundColor, withoutWallpaper: UIColor(rgb: 0x596e89, alpha: 0.35)), actionButtonsStrokeColor: PresentationThemeVariableColor(color: .clear),
           actionButtonsTextColor: PresentationThemeVariableColor(color: UIColor(rgb: 0xffffff)), textSelectionColor: defaultDayAccentColor.withAlphaComponent(0.2), textSelectionKnobColor: defaultDayAccentColor),
       outgoing: swordOutgoingMessage(isForTransaction: false),
       freeform: PresentationThemeBubbleColor(
           withWallpaper: PresentationThemeBubbleColorComponents(
               fill: [UIColor(rgb: 0xffffff)],
               highlightedFill: UIColor(rgb: 0xd9f4ff),
       ...
       infoPrimaryTextColor: UIColor(rgb: 0x000000),
       infoLinkTextColor: UIColor(rgb: 0x004bad),
       outgoingCheckColor: UIColor(rgb: 0x5195F2),
       mediaDateAndStatusFillColor: UIColor(white: 0.0, alpha: 0.3),
       mediaDateAndStatusTextColor: UIColor(rgb: 0xffffff),
       shareButtonFillColor: PresentationThemeVariableColor(withWallpaper: serviceBackgroundColor, withoutWallpaper: UIColor(rgb: 0x748391, alpha: 0.45)),
       shareButtonStrokeColor: PresentationThemeVariableColor(withWallpaper: .clear, withoutWallpaper: .clear),
...
public func swordOutgoingMessage(isForTransaction: Bool) ->  PresentationThemePartedColors {
    let bubbleStrokeColor = defaultServiceBackgroundColor.withMultiplied(hue: 0.999, saturation: 1.667, brightness: 1.1).withAlphaComponent(0.2)
    let fillColor = isForTransaction ? UIColor(rgb: 0x093489) : UIColor(rgb: 0xabcdff)
    return PresentationThemePartedColors(
        bubble: PresentationThemeBubbleColor(
            withWallpaper: PresentationThemeBubbleColorComponents(
                fill: [fillColor],
                highlightedFill: fillColor.withAlphaComponent(0.8),
                stroke: bubbleStrokeColor,
                shadow: nil,
                reactionInactiveBackground: .white.withMultipliedAlpha(0.12),
                reactionInactiveForeground: .white,
                reactionActiveBackground: .white,
                reactionActiveForeground: UIColor(rgb: 0xabcdff),
                reactionInactiveMediaPlaceholder: UIColor(rgb: 0xffffff, alpha: 0.2),
                reactionActiveMediaPlaceholder: UIColor(rgb: 0xffffff, alpha: 0.2)
            ),
            withoutWallpaper: PresentationThemeBubbleColorComponents(
                ...
                shadow: nil,
                reactionInactiveBackground: .white.withMultipliedAlpha(0.12),
                reactionInactiveForeground: .clear,
                reactionActiveBackground: .white,
                reactionActiveForeground: .clear,
                reactionInactiveMediaPlaceholder: UIColor(rgb: 0xffffff, alpha: 0.2),
                reactionActiveMediaPlaceholder: UIColor(rgb: 0xffffff, alpha: 0.2)
        ...
        primaryTextColor: UIColor(rgb: 0x2F3032),
        secondaryTextColor: isForTransaction ? .white : UIColor(rgb: 0x000000).withAlphaComponent(0.25),
        linkTextColor: UIColor(rgb: 0x004bad),
        linkHighlightColor: defaultDayAccentColor.withAlphaComponent(0.3),
        scamColor: UIColor(rgb: 0xff3b30),
        textHighlightColor: UIColor(rgb: 0xffe438),
        accentTextColor: .white,
        accentControlColor: .white,
        accentControlDisabledColor: .white.withAlphaComponent(0.7),
        mediaActiveControlColor: .white,
        mediaInactiveControlColor: .white.withAlphaComponent(0.8),
        mediaControlInnerBackgroundColor: .white,
        pendingActivityColor: UIColor(rgb: 0x5195F2),
        fileTitleColor: .white,
        fileDescriptionColor: .white,
        fileDurationColor: .white.withAlphaComponent(0.8),
        mediaPlaceholderColor: UIColor(rgb: 0xd2f2b6),
        polls: PresentationThemeChatBubblePolls(radioButton: UIColor(rgb: 0x93d987), radioProgress: UIColor(rgb: 0x3fc33b), highlight: UIColor(rgb: 0x3fc33b).withAlphaComponent(0.08), separator: UIColor(rgb: 0x93d987), bar: UIColor(rgb: 0x00A700), barIconForeground: .white, barPositive: UIColor(rgb: 0x00A700), barNegative: UIColor(rgb: 0x00A700)),
        actionButtonsFillColor: PresentationThemeVariableColor(withWallpaper: defaultServiceBackgroundColor, withoutWallpaper: UIColor(rgb: 0x596e89, alpha: 0.35)),
        actionButtonsStrokeColor: PresentationThemeVariableColor(color: .white),
        actionButtonsTextColor: PresentationThemeVariableColor(color: UIColor(rgb: 0xffffff)),
        textSelectionColor: UIColor(rgb: 0xbbde9f),
        textSelectionKnobColor: UIColor(rgb: 0x3fc33b))
}
