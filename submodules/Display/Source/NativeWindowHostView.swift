...
private final class WindowRootViewController: UIViewController, UIViewControllerPreviewingDelegate {
    ...
    // MARK: - SwordChange / Come here when app will be in buildable state
...
//                return nil
//            }
//            if let (result, resultPoint) = tracePreviewingHostView(view: result, point: self.view.convert(location, to: result)),
//               let delegate = result.previewingDelegate {
...
//                    return controller.action previousPreviewingHostView
//                }
//            }
//        }
        return nil
