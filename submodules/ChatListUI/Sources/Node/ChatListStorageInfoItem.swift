...
//            let okButtonLayout: (TextNodeLayout, () -> TextNode)?
//            let cancelButtonLayout: (TextNodeLayout, () -> TextNode)?
            ...
            let contentSize = CGSize(width: params.width, height: verticalInset * 2.0 + titleLayout.0.size.height + textLayout.0.size.height)
