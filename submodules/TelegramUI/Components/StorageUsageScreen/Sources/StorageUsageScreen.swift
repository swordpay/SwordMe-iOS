        ...
        func update(component: StorageUsageScreenComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<ViewControllerComponentContainer.Environment>, transition: Transition) -> CGSize {
            ...
            if listCategories.isEmpty {
                ...
                if let _ = component.peer {
                    ...
                    totalUsageText = environment.strings.StorageManagement_DescriptionAppUsage(fractionString).string.replacingOccurrences(of: "Telegram", with: "Sword")
                }
            } else {
                totalUsageText = " "
            }
            ...
            if !listCategories.isEmpty {
                ...
                let categoriesDescriptionSize = self.categoriesDescriptionView.update(
                    transition: transition,
                    component: AnyComponent(MultilineTextComponent(text: .markdown(text: environment.strings.StorageManagement_SectionsDescription.replacingOccurrences(of: "Telegram", with: "Sword"), attributes: MarkdownAttributes(
                        body: body,
                        bold: bold,
                        link: body,
                        linkAttribute: { _ in nil }
