...
@objc open class ViewController: UIViewController, ContainableController {
    ...
    open func presentNotFromRoot(_ viewControllerToPresent: UIViewController, animated flag: Bool, completion: (() -> Void)? = nil) {
        super.present(viewControllerToPresent, animated: flag, completion: completion)
    }

    open func dismissNotFromRoot(animated flag: Bool, completion: (() -> Void)? = nil) {
