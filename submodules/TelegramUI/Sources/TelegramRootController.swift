...
public final class TelegramRootController: NavigationController {
    ...
    public var homeController: HomeViewController?
    public var contactsController: ContactsController?
    public var callListController: CallListController?
    public var chatListController: ChatListController?
    public var accountSettingsController: PeerInfoScreen?
    public var cryptoAccountViewController: CryptoAccountViewController?
    ...
    // MARK: - Foced disappeareed calls tab
...
//        controllers.append(contactsController)
        ...
        // TODO: - Maybe this should be opened
//        if showCallsTab {
...
//        }
        ...
        let cryptoAccountViewController = ViewControllerProvider.CryptoAccount.cryptoAccount(context: context)
        
//        controllers.append(contactsController)

        controllers.append(cryptoAccountViewController)
...
//        self.homeController = homeVC
        ...
        self.cryptoAccountViewController = cryptoAccountViewController
...
//        controllers.append(self.contactsController!)
        ...
        controllers.append(self.cryptoAccountViewController!)
    ...
    private func bindToLogout() {
        print("Root Controller \(self)")
        NotificationCenter.default.publisher(for: Notification.Name(rawValue: "appLogout"))
            .sink { [ weak self ] _ in
    ...
    private func bindToTopUpCompletion() {
        NotificationCenter.default.publisher(for: Notification.Name(rawValue: "topUpDidPressed"))
            .sink { [ weak self ] _ in
                guard let self else { return }
