...
public final class PresentationData: Equatable {
    ...
    public func withUpdatedNavigationBar() -> PresentationData {
        return PresentationData(strings: self.strings, theme: self.theme.withUpdated(rootController: self.theme.rootController.withUpdated(navigationBar: self.theme.rootController.navigationBar.withUpdated(blurredBackgroundColor: .white, opaqueBackgroundColor: .white))), autoNightModeTriggered: self.autoNightModeTriggered, chatWallpaper: self.chatWallpaper, chatFontSize: self.chatFontSize, chatBubbleCorners: self.chatBubbleCorners, listsFontSize: self.listsFontSize, dateTimeFormat: self.dateTimeFormat, nameDisplayOrder: self.nameDisplayOrder, nameSortOrder: self.nameSortOrder, reduceMotion: self.reduceMotion, largeEmoji: self.largeEmoji)
    }
