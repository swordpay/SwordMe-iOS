...
public final class NavigationBarTheme {
    ...
    public func withUpdatedButtonColor(_ color: UIColor) -> NavigationBarTheme {
        return NavigationBarTheme(buttonColor: color, disabledButtonColor: self.disabledButtonColor, primaryTextColor: self.primaryTextColor, backgroundColor: self.backgroundColor, enableBackgroundBlur: self.enableBackgroundBlur, separatorColor: separatorColor, badgeBackgroundColor: self.badgeBackgroundColor, badgeStrokeColor: self.badgeStrokeColor, badgeTextColor: self.badgeTextColor)
    }
