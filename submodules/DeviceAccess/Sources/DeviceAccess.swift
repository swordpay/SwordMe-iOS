                ...
                case let .camera(cameraSubject):
                    ...
                    if status == PGCameraAuthorizationStatusNotDetermined {
                                ...
                                Queue.mainQueue().async {
                                    ...
                                    if !response, let presentationData = presentationData {
                                        ...
                                        switch cameraSubject {
                                            case .video:
                                                text = presentationData.strings.AccessDenied_Camera.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                            case .videoCall:
                                                text = presentationData.strings.AccessDenied_VideoCallCamera.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                            case .qrCode:
                                                text = presentationData.strings.AccessDenied_QrCamera.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                        }
                        ...
                        if status == PGCameraAuthorizationStatusRestricted {
                            text = presentationData.strings.AccessDenied_CameraRestricted.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                        } else {
                            switch cameraSubject {
                                case .video:
                                    text = presentationData.strings.AccessDenied_Camera.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                            ...
                            Queue.mainQueue().async {
                                if granted {
                                    ...
                                    switch microphoneSubject {
                                        case .audio:
                                            text = presentationData.strings.AccessDenied_VoiceMicrophone.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                        case .video:
                                            text = presentationData.strings.AccessDenied_VideoMicrophone.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                        case .voiceCall:
                                            text = presentationData.strings.AccessDenied_CallMicrophone.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                    }
                                    present(standardTextAlertController(theme: AlertControllerTheme(presentationData: presentationData), title: presentationData.strings.AccessDenied_Title, text: text, actions: [TextAlertAction(type: .defaultAction, title: presentationData.strings.Common_NotNow, action: {}), TextAlertAction(type: .genericAction, title: presentationData.strings.AccessDenied_Settings, action: {
                                        openSettings()
                                    })]), nil)
                        ...
                        Queue.mainQueue().async {
                            if value {
                                ...
                                switch mediaLibrarySubject {
                                    case .send:
                                        text = presentationData.strings.AccessDenied_PhotosAndVideos.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                    case .save:
                                        text = presentationData.strings.AccessDenied_SaveMedia.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                    case .wallpaper:
                                        text = presentationData.strings.AccessDenied_Wallpapers.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                    case .qrCode:
                                        text = presentationData.strings.AccessDenied_QrCode.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                }
                                present(standardTextAlertController(theme: AlertControllerTheme(presentationData: presentationData), title: presentationData.strings.AccessDenied_Title, text: text, actions: [TextAlertAction(type: .defaultAction, title: presentationData.strings.Common_NotNow, action: {}), TextAlertAction(type: .genericAction, title: presentationData.strings.AccessDenied_Settings, action: {
                                    openSettings()
                                })]), nil)
                        ...
                        case .authorizedAlways:
                            if case .live = locationSubject, !hasPreciseLocation {
                                ...
                                if let presentationData = presentationData {
                                    let text = presentationData.strings.AccessDenied_LocationPreciseDenied.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                    present(standardTextAlertController(theme: AlertControllerTheme(presentationData: presentationData), title: presentationData.strings.AccessDenied_Title, text: text, actions: [TextAlertAction(type: .defaultAction, title: presentationData.strings.Common_NotNow, action: {}), TextAlertAction(type: .genericAction, title: presentationData.strings.AccessDenied_Settings, action: {
                                        openSettings()
                                    })]), nil)
                                }
                        ...
                        case .authorizedWhenInUse:
                            switch locationSubject {
                                ...
                                case .live:
                                    completion(false)
                                    if let presentationData = presentationData {
                                        let text = presentationData.strings.AccessDenied_LocationAlwaysDenied.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                        present(standardTextAlertController(theme: AlertControllerTheme(presentationData: presentationData), title: presentationData.strings.AccessDenied_Title, text: text, actions: [TextAlertAction(type: .defaultAction, title: presentationData.strings.Common_NotNow, action: {}), TextAlertAction(type: .genericAction, title: presentationData.strings.AccessDenied_Settings, action: {
                                            openSettings()
                                        })]), nil)
                                    }
                        ...
                        case .denied, .restricted:
                            ...
                            if let presentationData = presentationData {
                                ...
                                if status == .denied {
                                    switch locationSubject {
                                        case .send, .live:
                                            text = presentationData.strings.AccessDenied_LocationDenied.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                        case .tracking:
                                            text = presentationData.strings.AccessDenied_LocationTracking.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                    }
                                } else {
                                    text = presentationData.strings.AccessDenied_LocationDisabled.replacingOccurrences(of: "Telegram", with: "Sword Pay")
                                }
                                present(standardTextAlertController(theme: AlertControllerTheme(presentationData: presentationData), title: presentationData.strings.AccessDenied_Title, text: text, actions: [TextAlertAction(type: .defaultAction, title: presentationData.strings.Common_NotNow, action: {}), TextAlertAction(type: .genericAction, title: presentationData.strings.AccessDenied_Settings, action: {
                                    openSettings()
                                })]), nil)
