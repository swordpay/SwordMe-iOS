...
public final class PresentationThemeIntro {
    ...
    public let highlightedDotColor: UIColor
    
    public init(statusBarStyle: PresentationThemeStatusBarStyle, primaryTextColor: UIColor, accentTextColor: UIColor, disabledTextColor: UIColor, startButtonColor: UIColor, dotColor: UIColor, highlightedDotColor: UIColor) {
    ...
    public func withUpdated(statusBarStyle: PresentationThemeStatusBarStyle? = nil, primaryTextColor: UIColor? = nil, accentTextColor: UIColor? = nil, disabledTextColor: UIColor? = nil, startButtonColor: UIColor? = nil, dotColor: UIColor? = nil, highlightedDotColor: UIColor? = nil) -> PresentationThemeIntro {
        return PresentationThemeIntro(statusBarStyle: statusBarStyle ?? self.statusBarStyle, primaryTextColor: primaryTextColor ?? self.primaryTextColor, accentTextColor: accentTextColor ?? self.accentTextColor, disabledTextColor: disabledTextColor ?? self.disabledTextColor, startButtonColor: startButtonColor ?? self.startButtonColor, dotColor: dotColor ?? self.dotColor, highlightedDotColor: highlightedDotColor ?? self.highlightedDotColor)
    }
}
...
public final class PresentationThemeBubbleColorComponents {
    public var fill: [UIColor] // Update to var, for transaction node background color
...
public final class PresentationThemeChatMessage {
    ...
    public var outgoing: PresentationThemePartedColors
    ...
    public func withUpdatedColors(isForTransaction: Bool) -> PresentationThemeChatMessage {
        let color = isForTransaction ? UIColor(rgb: 0x51D323) : UIColor(rgb: 0x77abff)
        return PresentationThemeChatMessage(incoming: self.incoming, outgoing: self.outgoing.withUpdated(pendingActivityColor: color), freeform: self.freeform, infoPrimaryTextColor: self.infoPrimaryTextColor, infoLinkTextColor: self.infoLinkTextColor, outgoingCheckColor: color, mediaDateAndStatusFillColor: self.mediaDateAndStatusFillColor, mediaDateAndStatusTextColor: self.mediaDateAndStatusTextColor, shareButtonFillColor: self.shareButtonFillColor, shareButtonStrokeColor:  self.shareButtonStrokeColor, shareButtonForegroundColor: self.shareButtonForegroundColor, mediaOverlayControlColors: self.mediaOverlayControlColors, selectionControlColors: self.selectionControlColors, deliveryFailedColors: self.deliveryFailedColors, mediaHighlightOverlayColor: self.mediaHighlightOverlayColor, stickerPlaceholderColor: self.stickerPlaceholderColor, stickerPlaceholderShimmerColor: self.stickerPlaceholderShimmerColor)
    }
}
...
public final class PresentationTheme: Equatable {
    ...
    public func withUpdated(rootController: PresentationThemeRootController) -> PresentationTheme {
        return PresentationTheme(name: self.name, index: self.index, referenceTheme: self.referenceTheme, overallDarkAppearance: self.overallDarkAppearance, intro: self.intro, passcode: self.passcode, rootController: rootController, list: self.list, chatList: self.chatList, chat: self.chat, actionSheet: self.actionSheet, contextMenu: self.contextMenu, inAppNotification: self.inAppNotification, chart: self.chart, preview: preview)
    }
    ...
    public func withUpdatedOutgoingMessage(isForTransaction: Bool) -> PresentationTheme {
        return PresentationTheme(name: self.name, index: self.index, referenceTheme: self.referenceTheme, overallDarkAppearance: self.overallDarkAppearance, intro: self.intro, passcode: self.passcode,
                                 rootController:self.rootController,
                                 list: list,
                                 chatList: self.chatList,
                                 chat: self.chat.withUpdated(message: self.chat.message.withUpdated(outgoing: swordOutgoingMessage(isForTransaction: isForTransaction))
                                    .withUpdatedColors(isForTransaction: isForTransaction)),
                                 actionSheet: self.actionSheet,
