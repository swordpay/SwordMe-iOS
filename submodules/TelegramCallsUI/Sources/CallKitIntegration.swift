...
public final class CallKitIntegration {
    ...
    private func donateIntent(peerId: PeerId, displayTitle: String, localContactId: String?) {
        if #available(iOSApplicationExtension 10.0, iOS 10.0, *) {
            ...
            // MARK: - SwordChange adapted deprecated api
            let intent = INStartCallIntent(callRecordFilter: nil, callRecordToCallBack: nil, audioRoute: .speakerphoneAudioRoute, destinationType: .normal, contacts: [contact], callCapability: .audioCall)
